document.addEventListener("DOMContentLoaded", () => {
    const eventosGrid = document.getElementById("event_data");
    let eventos = [];

    // Función para cargar eventos desde JSON
    const cargarEventos = async () => {
        try {
            const response = await fetch("/data/eventos.json"); // Ruta del JSON
    ...
    // Renderizar eventos
    const renderEventos = () => {
        eventosGrid.innerHTML = ""; // Limpiar contenido previo
